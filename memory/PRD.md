...
- v4 (2026-08-14, user feedback): primary accent shifted from #D4C942 to lighter #E8DC6A (buttons, links, icons, highlights, ticker, gradients, glows; readable light-bg variant #9C8F22 kept for text on white). Section numbering removed from homepage chapter pills (inner pages keep step numbers). Whitespace compressed further: sections py-12/16, cards p-5, hero pt-24/pb-12, PageHero pt-24/pb-10.
