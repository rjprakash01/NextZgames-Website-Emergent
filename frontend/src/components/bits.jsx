  ...
  <Reveal>
    <div
      ...
      className={`inline-flex items-center gap-2.5 rounded-full border px-4 py-1.5 ${
        tone === "light"
          ? "border-[#23401F]/20 bg-white text-[#A3941F]"
    ...
    >
      {n && (
        <>
          ...
          <span className={`h-2.5 w-px ${tone === "light" ? "bg-[#23401F]/25" : "bg-[#EFE35F]/40"}`} />
        </>
      )}
...
export const PageHero = ({ chapter, label, title, sub, children }) => (
  <section className="relative overflow-hidden bg-[#23401F] pt-20 pb-8 md:pt-24 md:pb-10">
