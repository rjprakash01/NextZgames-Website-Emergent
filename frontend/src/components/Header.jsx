    ...
    <>
      <header
        ...
        className={`fixed inset-x-0 top-0 z-50 transition-[background-color,border-color,backdrop-filter] duration-500 ${
          scrolled || open
            ? "bg-[#1B3A17]/90 backdrop-blur-md border-b border-[#EFE35F]/15"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-x-0 top-[72px] z-40 lg:hidden bg-[#1B3A17]/95 backdrop-blur-md border-b border-[#EFE35F]/15"
          >
