...
const AppHeader = ({ title }) => (
  <div className="flex items-center justify-between px-4 pt-3">
    <span className="font-heading text-[10px] font-extrabold tracking-[0.25em] text-white">
      NEXTZ<span className="text-[#E3B84A]">GAMES</span>
    </span>
    <span className="h-5 w-5 rounded-full bg-[#E3B84A]/25 border border-[#E3B84A]/50" />
  </div>
);
...
const screens = {
  home: (
    <>
      <AppHeader />
      <div className="mx-3 mt-3 rounded-xl bg-[#30512D] p-3 border border-[#E3B84A]/20">
        <p className="text-[7px] uppercase tracking-[0.2em] text-white/50">Total Balance</p>
        <p className="font-heading text-lg font-extrabold text-[#E3B84A]">₹ 2,450.00</p>
      </div>
      <div className="mx-3 mt-2 grid grid-cols-2 gap-2">
        <div className="rounded-xl bg-[#122A0E] border border-[#E3B84A]/30 p-3">
      ...
      <div className="mx-3 mt-2 rounded-xl bg-gradient-to-r from-[#E3B84A] to-[#CDBF4D] p-3">
      ...
      <div className="mt-auto mx-3 mb-3 flex justify-between rounded-xl bg-black/30 px-4 py-2 text-[7px] text-white/50">
        <span className="text-[#E3B84A]">Home</span><span>Poker</span><span>Predict</span><span>Wallet</span>
      </div>
    </>
  ),
  poker: (
      ...
      <div className="mx-3 mt-2 space-y-2">
        {[
          ...
          <div key={name} className="flex items-center justify-between rounded-xl bg-[#30512D]/70 border border-white/8 px-3 py-2.5">
            ...
            <span className="rounded-full bg-[#E3B84A] px-2.5 py-1 font-heading text-[7px] font-extrabold text-[#122A0E]">JOIN</span>
          </div>
        ))}
      </div>
      <div className="mt-auto mx-3 mb-3 flex justify-between rounded-xl bg-black/30 px-4 py-2 text-[7px] text-white/50">
        <span>Home</span><span className="text-[#E3B84A]">Poker</span><span>Predict</span><span>Wallet</span>
      </div>
    </>
  ),
  table: (
    <>
      ...
      <div className="relative mx-3 mt-2 flex-1 rounded-2xl border border-white/15 bg-[radial-gradient(circle_at_center,#2A4C25_0%,#122A0E_60%,#142C11_100%)]">
        <div className="absolute left-1/2 top-6 -translate-x-1/2 rounded-full bg-black/40 px-3 py-1 text-center">
          ...
          <p className="font-heading text-[10px] font-extrabold text-[#E3B84A]">₹ 1,280</p>
        </div>
        ...
        <div className="absolute bottom-12 left-1/2 flex -translate-x-1/2 gap-1.5">
          {["9♠", "9♥"].map((c) => (
            <span key={c} className="flex h-9 w-7 items-center justify-center rounded border-2 border-[#E3B84A] bg-white font-heading text-[9px] font-extrabold text-[#122A0E] shadow-lg">{c}</span>
          ))}
        </div>
        <div className="absolute bottom-3 left-1/2 flex -translate-x-1/2 gap-1.5 text-[7px] font-heading font-bold">
          ...
          <span className="rounded-full bg-[#E3B84A] px-3 py-1.5 text-[#122A0E]">RAISE</span>
        </div>
      </div>
      <div className="mb-3" />
    </>
    ...
    <>
      ...
      <div className="mx-3 mt-2 rounded-xl bg-[#30512D]/70 border border-white/15 p-3">
        ...
        <div className="mt-2 grid grid-cols-2 gap-2">
          <span className="rounded-lg bg-[#E3B84A] py-2 text-center font-heading text-[8px] font-extrabold text-[#122A0E]">MUMBAI · 1.85</span>
      ...
      <div className="mt-auto mx-3 mb-3 rounded-xl bg-[#E3B84A] py-2.5 text-center font-heading text-[8px] font-extrabold tracking-widest text-[#122A0E]">
  ...
  wallet: (
    <>
      <AppHeader />
      <div className="mx-3 mt-3 rounded-2xl border border-[#E3B84A]/30 bg-gradient-to-br from-[#30512D] to-[#122A0E] p-4">
        ...
        <div className="mt-3 flex gap-2">
          <span className="rounded-full bg-[#E3B84A] px-3 py-1.5 font-heading text-[7px] font-extrabold text-[#122A0E]">ADD FUNDS</span>
      ...
      <div className="mx-3 mt-1.5 space-y-1.5">
        {[["Poker Buy-in", "-₹500"], ["Prediction Won", "+₹370"], ["Deposit UPI", "+₹1,000"]].map(([t, a]) => (
          <div key={t} className="flex justify-between rounded-lg bg-black/25 px-3 py-2">
            ...
            <span className={`font-heading text-[8px] font-bold ${a.startsWith("+") ? "text-[#E3B84A]" : "text-white/60"}`}>{a}</span>
          </div>
        ))}
      </div>
      <div className="mt-auto mx-3 mb-3 flex justify-between rounded-xl bg-black/30 px-4 py-2 text-[7px] text-white/50">
        <span>Home</span><span>Poker</span><span>Predict</span><span className="text-[#E3B84A]">Wallet</span>
      </div>
    </>
  ),
};
