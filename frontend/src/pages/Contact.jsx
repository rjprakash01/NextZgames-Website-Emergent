            ...
            <Reveal delay={0.1}>
              <div className="mt-6 space-y-6">
                <div className="flex items-start gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#23401F] text-[#EFE35F]"><Mail size={18} /></span>
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Support Email</p>
                    <a href="mailto:support@nextzgames.com" data-testid="contact-email" className="mt-1 block font-heading font-bold text-[#1B3318] hover:text-[#A3941F]">support@nextzgames.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#23401F] text-[#EFE35F]"><Clock size={18} /></span>
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Support Hours</p>
                    <p className="mt-1 font-heading font-bold text-[#1B3318]">Mon – Sun, 9:00 – 21:00 IST</p>
                  </div>
                </div>
                <div>
                  <p className="text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Follow Us</p>
                  <div className="mt-3 flex gap-3">
                    {SOCIALS.map(({ icon: Icon, label }) => (
                      <a key={label} href="#" aria-label={label} data-testid={`contact-social-${label.toLowerCase()}`} className="flex h-10 w-10 items-center justify-center rounded-full border border-[#23401F]/20 text-[#1B3318]/60 transition-colors duration-300 hover:border-[#23401F] hover:bg-[#23401F] hover:text-[#EFE35F]">
                        <Icon size={16} />
                      </a>
                    ))}
                  </div>
                </div>
                <p className="text-sm text-[#1B3318]/60">
          ...
          <Reveal delay={0.15}>
            <form onSubmit={submit} className="card-light p-8 md:p-10" data-testid="contact-form">
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  <label htmlFor="cf-name" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Name</label>
                ...
                <div>
                  <label htmlFor="cf-email" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Email</label>
                ...
                <div>
                  <label htmlFor="cf-mobile" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Mobile Number</label>
                ...
                <div>
                  <label htmlFor="cf-category" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Category</label>
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="cf-subject" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Subject</label>
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="cf-message" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#1B3318]/50">Message</label>
