  ...
  return (
    <>
      <PageHero
        chapter="@"
        label="Contact"
        title={<>Talk to <span className="text-[#254F1F]">the Team</span></>}
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <div className="mt-6 space-y-6">
                ...
                <div>
                  <p className="text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Follow Us</p>
                  <div className="mt-3 flex gap-3">
                    {SOCIALS.map(({ icon: Icon, label }) => (
                      <a key={label} href="#" aria-label={label} data-testid={`contact-social-${label.toLowerCase()}`} className="flex h-10 w-10 items-center justify-center rounded-full border border-[#254F1F]/20 text-[#254F1F]/60 transition-colors duration-300 hover:border-[#254F1F] hover:bg-[#EFE35F] hover:text-[#254F1F]">
                        <Icon size={16} />
                      </a>
                    ))}
                  </div>
          ...
          <Reveal delay={0.15}>
            <form onSubmit={submit} className="card-light p-8 md:p-10" data-testid="contact-form">
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  <label htmlFor="cf-name" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Name</label>
                ...
                <div>
                  <label htmlFor="cf-email" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Email</label>
                ...
                <div>
                  <label htmlFor="cf-mobile" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Mobile Number</label>
                ...
                <div>
                  <label htmlFor="cf-category" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Category</label>
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="cf-subject" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Subject</label>
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="cf-message" className="mb-2 block text-[11px] uppercase tracking-[0.25em] text-[#254F1F]/50">Message</label>
