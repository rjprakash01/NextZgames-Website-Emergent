  ...
  return (
    <>
      <PageHero
        chapter="?"
        label="How It Works"
        title={<>Getting Started <span className="text-[#254F1F]">Is Simple</span></>}
              ...
              <Reveal key={s.n} delay={0.06 * i}>
                <div className="relative flex gap-6 md:gap-8" data-testid={`how-page-step-${s.n}`}>
                  ...
                  <div className="pt-1.5">
                    <h2 className="font-heading text-xl font-extrabold text-[#254F1F]">{s.title}</h2>
                    <p className="mt-1.5 max-w-lg text-sm text-[#254F1F]/65">{s.desc}</p>
                  </div>
                </div>
              </Reveal>
            ))}
