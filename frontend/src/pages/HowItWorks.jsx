...
export default function HowItWorks() {
  ...
  return (
    <>
      ...
      />
      <section className="section-light py-16 md:py-24" data-testid="steps-section">
            ...
            {HOW_IT_WORKS_STEPS.map((s, i) => (
              <Reveal key={s.n} delay={0.06 * i}>
                <div className="relative flex gap-6 md:gap-8" data-testid={`how-page-step-${s.n}`}>
                  <span className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-[#284525] bg-[#284525] font-heading text-base font-extrabold text-[#D4C942] shadow-[0_10px_24px_rgba(24,43,23,0.25)]">
                    {s.n}
                  </span>
