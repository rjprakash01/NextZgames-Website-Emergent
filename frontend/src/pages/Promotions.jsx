            ...
            return (
              <Reveal key={p.slug} delay={0.05 * i}>
                ...
                >
                  ...
                  <div>
                    <h2 className="font-heading text-xl font-extrabold text-[#284525]">{p.title}</h2>
                    <p className="mt-2 max-w-xl text-sm text-[#284525]/65">{p.desc}</p>
                    <div className="mt-4 grid gap-2.5 text-xs text-[#284525]/55 sm:grid-cols-3">
