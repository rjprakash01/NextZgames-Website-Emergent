...
export default function Poker() {
  ...
  return (
    <>
      ...
      <section className="section-light py-8 md:py-12" data-testid="poker-lobby-section">
        <div className="mx-auto grid max-w-6xl items-center gap-8 px-6 lg:grid-cols-2">
          <Reveal className="relative order-2 mx-auto lg:order-1">
            <img src="/creative-poker.jpg" alt="NextZGames Poker lobby — cash games and tournaments" loading="lazy" className="relative w-[240px] md:w-[280px] rounded-[1.8rem] border border-[#1B3A17]/15 rotate-2 shadow-[0_30px_60px_rgba(24,43,23,0.25)]" />
          </Reveal>
          <div className="order-1 lg:order-2">
            ...
            <Reveal delay={0.2}>
              <p className="mt-3 max-w-md text-sm md:text-base text-[#1B3A17]/65">
      ...
      <section className="bg-[#1B3A17] py-8 md:py-12" data-testid="poker-features-section">
      ...
      <section className="bg-[#1B3A17] py-16 text-center" data-testid="poker-cta">
